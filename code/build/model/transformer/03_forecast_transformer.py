...
try:
    ...
    print(f"ERROR: Could not import from models.py. Ensure it exists in {parent_dir}. Details: {e}")
    sys.exit(1)

try:
    import config
except ImportError:
    print(f"ERROR: config.py not found. Make sure it's in {parent_dir} or sys.path is configured correctly.")
    sys.exit(1)
